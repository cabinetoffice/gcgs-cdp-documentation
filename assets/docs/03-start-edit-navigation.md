...
Select the Code tab at the top of the repository to view the repository files and branches.
   ...
   <img src="../images/01-select-code-tab.png" width="300">


## Step 3 – Switch to the branch that contains your edited content

Use the branch dropdown to switch to the branch that contains your edited content.

<img src="../images/01a-select-base-branch.png" width="300">

Continue to the next guide to edit your site navigation.

---

← Back to [Edit content](./02-edit-content.md)

Next → [Edit navigation](./04-edit-navigation.md)